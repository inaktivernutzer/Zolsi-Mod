...
public final class TickHookTransformer implements ClassFileTransformer {

    static final String TARGET = "net/minecraft/client/Minecraft";
    private static final String HOOK_METHOD = "tick";
    public static final String HOOK_PROPERTY = "zolsi.tickHook";
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        try {
            ...
            ZolsiLog.log("Minecraft.tick transform succeeded (" + result.length + " bytes)");
            return result;
        } catch (Throwable t) {
            ZolsiLog.log("Minecraft.tick transform FAILED", t);
            return null;
        }
    }
